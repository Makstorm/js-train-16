...
function filterStudentsByGrade(students, grade) {
  ...
  const filteredStudents = students.filter((e) => e.grade === grade);

  filteredStudents.forEach((e) => console.log(e.name));
}
...
function calculateTotalPrice(products) {
  ...
  let total = products.reduce((acc, el) => acc + el.price, 0);
...
function countVowelsAndConsonants(word) {
  ...
  for (let char of word) {
    if (leters.includes(char.toLowerCase())) {
